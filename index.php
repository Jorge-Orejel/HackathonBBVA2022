...
<head>
    ...
    <title>Hackathon BBVA 2022 - Reto Autenticación - Autenticación Previa</title>
    <meta name="description" content="Hackathon BBVA 2022 - Autenticación">
    ...
    <main>
                ...
                <div class="single-slider hero-overly slider-height slider-bg1 d-flex align-items-center">
                    <div class="container">
                        <div class="row">
                            <div class="col-xl-8 col-lg-8 col-md-8 col-sm-10">
                                <div class="hero__caption">
                                    <h1 data-animation="fadeInUp" data-delay=".2s">Accesibilidad</h1>
        ...
        <div class="visit-tailor-area fix">
            ...
            <div class="tailor-details">
                ...
                <h2>La razón de ser de<br>Autenticación Previa</h2>
                <p>En el equipo Mototlis, buscamos desarrollar una innovadora solución que permita a cada uno de nuestros usuarios con alguna discapacidad   y adultos mayores poder autenticarse de una forma segura  e innovadora, para que con esto sea más fácil realizar  cualquier tipo de operaciones dentro del banco,  cabe mencionar que  gracias a  nuestras nuevas técnicas de autenticación podemos ahorrar mucho más tiempo  y agilizar el proceso de cada uno de los usuarios, siempre conservando la calidad y seguridad que ofrece BBVA.
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-6 col-sm-11">
                        <div class="single-cat text-center mb-30">
                            <div class="cat-icon">
                                <img src="assets/img/gallery/inclusion.png" alt="">
                            </div>
                            <div class="cat-cap">
                                <h5><a href="#">Autenticación Incluyente</a></h5>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6 col-sm-11">
                        <div class="single-cat active text-center mb-30">
                            <div class="cat-icon">
                                <img src="assets/img/gallery/identificacion_sucursal.png" alt="">
                            </div>
                            <div class="cat-cap">
                                <h5><a href="#">Identificación Inteligente</a></h5>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6 col-sm-11">
                        <div class="single-cat text-center mb-30">
                            <div class="cat-icon">
                                <img src="assets/img/gallery/XHolo.jpg" alt="">
                            </div>
                            <div class="cat-cap">
                                <h5><a href="#">Asistencia Virtual</a></h5>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="support-wrapper align-items-center">
                <div class="left-content">
                    ...
                    <div class="section-tittle section-tittle2 mb-30">
                        <span>Autentícate de denantes</span>
                        <!--<h2></h2>-->
                    </div>
                    <div class="support-caption">
                        <p class="pera-top">Con Autenticación Previa vive a velocidad luz, "a lo que te traje Chencha".
                        Identifícate desde tu app móvil o en el asistente virtual, indica la operación o servicio que deseas realizar.
                        Al llegar al banco o al cajero automático escanea el QR que se generó para tu transacción y no realices clics
                        de más, tu operación se realizará de volón pin pon. </p>
                        <a href="registro_productos.php" class="border-btn">Aportar a nuestra comunidad</a>
                    </div>
                </div>
                <div class="right-content">
                    <!-- img -->
                    <div class="right-img">
                        <img src="assets/img/gallery/happy-businessman-talking-his-colleague-while-going-through-financial-reports-office.jpg" alt="">
                    </div>
                ...
                <div class="row justify-content-center">
                    <div class="col-xl-10 col-lg-10 ">
                        ...
                        <div class="section-tittle text-center mb-80">
                            ...
                            <p class="pl-20 pr-20">Aqui encontrarás algunos metodos de autenticación</p>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-lg-4 col-md-6 col-sm-6">
                        <div class="single-cases mb-40">
                            <div class="cases-img">
                                <img src="assets/img/gallery/watch.jpeg" alt="" height=350px>
                            </div>
                            <div class="cases-caption">
                                <h3><a href="#">Dispositivo de autenticación</a></h3>
                                <p>Autentícate con tu dispositivo personal.</p>
                                <!-- Progress Bar -->
                                ...
                                <!-- / progress -->
                                <div class="prices">
                                    <p><span>Para cajeros y Atención al cliente </span></p>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6 col-sm-6">
                        <div class="single-cases mb-40">
                            <div class="cases-img">
                                <img src="assets/img/gallery/27530.jpg" alt="" height=350px>
                            </div>
                            <div class="cases-caption">
